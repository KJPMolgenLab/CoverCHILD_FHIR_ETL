...
df_ed_share_month %>% 
  ...
  scale_fill_discrete(name = "ED Type", labels = c("AN", "BN", "oED")) +
...
df_ed_share_re_adm %>%
  ...
  scale_colour_discrete(name = "ED Diagnosis", labels = c("no ED", "ED")) +
  # geom_line(aes(colour = f50_prop_type)) +
  guides(x = guide_axis(angle = -90)) +
...
df_ed %>%
  ...
  scale_fill_discrete(name = "Type of encounter", labels = c("First presentation", "Early re-admission")) +
