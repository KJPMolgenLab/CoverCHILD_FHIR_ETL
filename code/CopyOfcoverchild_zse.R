...
if (exists("condition_reference_prefix", where = cfg) && nchar(cfg$condition_reference_prefix) >= 1) {
  condition_reference_prefix <- cfg$condition_reference_prefix
} else {
  condition_reference_prefix <- "Condition/"
}
