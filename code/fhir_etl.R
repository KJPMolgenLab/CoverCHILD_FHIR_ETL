...
load_inst_pkgs("tidyverse", "magrittr", "fhircrackr", "data.table")
...
#TODO: Can resource elements already be limited to search_cfg$elements in fhir_search_urls via _elements param?
