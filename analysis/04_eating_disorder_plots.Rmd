...
df_ed_covid_weekly_long %>% 
  ...
  scale_x_discrete(
    breaks = levels(df_ed_covid_weekly_long$adm_year_week)[seq(1, length(levels(df_ed_covid_weekly_long$adm_year_week)), 2)],
...
```{r}
df_ed_monthly_baseline <- df_ed_monthly_long %>% 
